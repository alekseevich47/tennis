# Graph Report - tennis  (2026-08-20)

## Corpus Check
- 242 files · ~222,638 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1241 nodes · 3798 edges · 83 communities (74 shown, 9 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 138 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ff3e2594`
...
Cohesion: 0.07
Nodes (70): EmptyState(), formatDayTitle(), StatsTrainingsCountModal(), CalendarStrip(), ArchiveModal(), formatDateRangeLabel(), buildTrainingPatch(), EditTrainingModal() (+62 more)
...
Cohesion: 0.07
Nodes (47): InfoTooltip(), FOCUSABLE_SELECTORS, Modal(), Toggle(), AdminPanelPage(), NotificationSettingsModal(), SETTINGS_ROWS, METRICS (+39 more)
...
Cohesion: 0.10
Nodes (34): AppHeader(), computeAnnualEndDate(), getCurrentSessions(), getModeCopy(), MembershipEditModal(), normalizeDateInput(), MembershipPeriodRangeField(), MembershipStartDateField() (+26 more)
...
### Community 57 - "log.js"
Cohesion: 0.06
Nodes (66): IconButton, MembershipIcon(), Spinner(), useToast(), MAX_AUTH_URL, PB_URL, getCollapsedLabel(), isUserChecked() (+58 more)
...
Cohesion: 0.19
Nodes (22): AlertDialogContext, INITIAL_STATE, useAlertDialog(), BroadcastModal(), defaultDatetimeLocal(), getAudienceLabel(), CreateTournamentPostModal(), EditTournamentPostModal() (+14 more)
...
Cohesion: 0.13
Nodes (21): ForceUpdateOverlay(), carouselSlideKey(), FullscreenImageViewer(), FullscreenSlideImage(), getOriginRect(), getWindowWidth(), isImagePaintReady(), itemSlideId() (+13 more)

### Community 65 - "ProfilePage.jsx"
Cohesion: 0.06
Nodes (58): PostUploadContext, PostUploadProvider(), usePostUpload(), TournamentPostUploadContext, TournamentPostUploadProvider(), useTournamentPostUpload(), PullToRefresh(), ScrollToTopButton() (+50 more)

### Community 67 - "media.js"
Cohesion: 0.15
Nodes (26): useFavorites(), PinnedBanner(), usePinnedThumbUrl(), PostMedia(), useInFeedViewport(), cache, getYadiskAlbumCache(), listeners (+18 more)

### Community 68 - "GalleryCommentModal.jsx"
Cohesion: 0.07
Nodes (51): react, Avatar(), ModalFloatingCloseButton(), TournamentCommentsSection(), getParticipantDisplayName(), getParticipantPlayer(), PODIUM_ORDER, TournamentPodium() (+43 more)

### Community 69 - "OnboardingTutorial.jsx"
Cohesion: 0.27
...
Cohesion: 0.05
Nodes (67): createGalleryPayload(), GalleryUploadContext, GalleryUploadProvider(), isGalleryKey(), useGalleryUpload(), isProductsKey(), ProductUploadContext, ProductUploadProvider() (+59 more)

### Community 71 - "App.jsx"
Cohesion: 0.27
Nodes (10): AppInner(), AppMain(), getInitialFavoriteProductIds(), TAB_TITLES, CloseAppConfirmSheet(), useSessionResetKey(), deleteProduct(), hardDeleteComment() (+2 more)
...
### Community 79 - "yadiskMediaSessionCache.js"
Cohesion: 0.29
...
### Community 81 - "AddActionContext.jsx"
Cohesion: 0.27
...
### Community 82 - "MediaPreviewGrid.jsx"
Cohesion: 0.28
Nodes (3): MediaPreviewAlbumItem(), MediaPreviewGrid(), useSwipeGallery()
...
- **Why does `error` connect `GalleryPage.jsx` to `App Shell Navigation`, `ProfilePage.jsx`, `Post Upload and UI Kit`, `notifications.js`, `GalleryCommentModal.jsx`, `Admin UI Controls`, `OnboardingTutorial.jsx`, `App.jsx`, `media.js`, `useMaxCloseGuard.js`, `datePickerUtils.js`, `log.js`, `achievements.js`, `yadiskAlbumLazy.js`?**
