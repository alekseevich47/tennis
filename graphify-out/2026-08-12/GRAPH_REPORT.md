...
## Corpus Check
- 223 files · ~206,749 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1115 nodes · 3412 edges · 77 communities (70 shown, 7 thin omitted)
...
Cohesion: 0.06
Nodes (88): AppInner(), AppMain(), getInitialFavoriteProductIds(), TAB_TITLES, CloseAppConfirmSheet(), FavoritesContext, FavoritesProvider(), loadFavoriteProducts() (+80 more)
...
Cohesion: 0.13
Nodes (15): App(), AvatarCropModal(), getCropCircle(), getImagePlacement(), AlertDialogProvider(), Toast(), ToastContext, ToastProvider() (+7 more)
...
### Community 7 - "App.jsx"
Cohesion: 0.20
Nodes (19): TournamentPostUploadContext, TournamentPostUploadProvider(), useTournamentPostUpload(), CompetitionsPage(), TABS, useTournamentPosts(), applyTournamentPostSideEffects(), buildTournamentPostPayload() (+11 more)
...
Cohesion: 0.05
Nodes (73): MembershipIcon(), useToast(), getCollapsedLabel(), isUserChecked(), UserMultiSelect(), CARD_STEPS, getStepSelectors(), getTooltipStyle() (+65 more)
...
Cohesion: 0.12
Nodes (31): FrameColorPicker(), hexToHsv(), hsvToHex(), PostFormatToolbar(), PostLinkModal(), ALLOWED_ATTRS, ALLOWED_TAGS, applyAnimFrame() (+23 more)

### Community 57 - "log.js"
Cohesion: 0.08
Nodes (58): AlertDialogContext, INITIAL_STATE, useAlertDialog(), Avatar(), FOCUSABLE_SELECTORS, Modal(), useFavorites(), CreateTournamentPostModal() (+50 more)
...
Cohesion: 0.22
Nodes (13): PostUploadContext, PostUploadProvider(), usePostUpload(), ScrollToTopButton(), FeedPage(), sortPinnedByCreated(), usePosts(), createPost() (+5 more)
...
Cohesion: 0.25
Nodes (13): filterProfileTrainings(), formatDateRangeLabel(), ProfileTrainingsSearch(), ArchiveModal(), formatDateRangeLabel(), findRussianMonth(), isDateQueryParsed(), matchesDateQuery() (+5 more)
...
Cohesion: 0.07
Nodes (55): ADMIN_NAV_ITEM, GALLERY_NAV_ITEM, NAV_ITEMS, IconButton, TournamentCommentsSection(), getParticipantDisplayName(), getParticipantPlayer(), PODIUM_ORDER (+47 more)
...
### Community 70 - "format.js"
Cohesion: 0.33
Nodes (7): CalendarStrip(), dayKey(), DAYS_FULL, DAYS_SHORT, isSameDay(), MONTHS_GENITIVE, pad2()
...
### Community 76 - "usePinnedBannerIndex.js"
Cohesion: 0.60
...
- **Why does `error` connect `App Shell Navigation` to `Post Upload and UI Kit`, `RatingPage.jsx`, `GalleryCommentModal.jsx`, `App.jsx`, `MembershipModal.jsx`, `datePickerUtils.js`, `log.js`, `catalog.js`, `FeedPage.jsx`, `achievements.js`?**
