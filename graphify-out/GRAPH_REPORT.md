...
## Corpus Check
- 304 files · ~267,302 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1578 nodes · 4851 edges · 104 communities (83 shown, 21 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 169 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bc63a0d5`
...
Cohesion: 0.10
Nodes (40): PinnedBanner(), usePinnedThumbUrl(), getFirstLine(), publishAlbums(), useResolvedExternalMedia(), cache, getYadiskAlbumCache(), listeners (+32 more)

### Community 3 - "notifications.js"
Cohesion: 0.09
Nodes (53): react, AlertDialogContext, INITIAL_STATE, useAlertDialog(), SystemTemplatesModal(), TemplateListButton(), CreateTournamentPostModal(), EditTournamentPostModal() (+45 more)
...
Cohesion: 0.15
Nodes (13): dependencies, @ffmpeg/core, gsap, mp4-muxer, react-router-dom, recharts, zustand, @ffmpeg/core (+5 more)
...
Cohesion: 0.27
Nodes (11): MembershipIcon(), formatDate(), getTrainingStatusForUser(), getTrainingTitle(), getUserPastTrainings(), normalizeDateInput(), ProfilePage(), TRAINING_BADGE (+3 more)
...
### Community 57 - "log.js"
Cohesion: 0.13
Nodes (38): TrainingCard(), TrainingDetailModal(), TrainingsPage(), useKeepForModalClose(), canCancelBooking(), formatCardDate(), formatTimeRange(), isModerator() (+30 more)
...
Cohesion: 0.22
Nodes (8): description, name, private, scripts, build, dev, preview, version
...
Cohesion: 0.05
Nodes (66): EmptyState(), IconButton, FOCUSABLE_SELECTORS, Modal(), Spinner(), AdminPanelPage(), ALL_CATEGORY_VALUES, formatDateRangeLabel() (+58 more)
...
Cohesion: 0.05
Nodes (67): createGalleryPayload(), GalleryUploadContext, GalleryUploadProvider(), getVideoAspectRatio(), isGalleryKey(), prepareGalleryUploadItem(), useGalleryUpload(), isProductsKey() (+59 more)

### Community 68 - "GalleryCommentModal.jsx"
Cohesion: 0.08
Nodes (33): AvatarCropModal(), getCropCircle(), getImagePlacement(), ForceUpdateOverlay(), CommentContextMenu(), carouselSlideKey(), FullscreenImageViewer(), FullscreenSlideImage() (+25 more)

### Community 70 - "useFetchedOriginal.js"
Cohesion: 0.05
Nodes (64): Avatar(), ModalFloatingCloseButton(), TournamentCommentsSection(), getParticipantDisplayName(), getParticipantPlayer(), PODIUM_ORDER, TournamentPodium(), readTournamentComments() (+56 more)
...
Cohesion: 0.05
Nodes (70): usePostUpload(), TournamentPostUploadContext, useTournamentPostUpload(), PullToRefresh(), ScrollToTopButton(), FeedListSkeleton(), RatingListSkeleton(), ShopGridSkeleton() (+62 more)

### Community 80 - "useMaxCloseGuard.js"
Cohesion: 0.06
Nodes (53): FavoritesContext, FavoritesProvider(), loadFavoriteProducts(), patchProductsFavoritesCount(), useFavorites(), buildEditMediaItems(), CommentMediaBody(), commentHasAttachments() (+45 more)

### Community 83 - "yadiskAlbumLazy.js"
Cohesion: 0.07
Nodes (46): AuditEventRow(), groupCommentsByDay(), groupItemsByDay(), groupPostsByDay(), mapCommentsWithDaySeparators(), mapItemsWithDaySeparators(), mapPostsWithDaySeparators(), htmlToReadableText() (+38 more)
...
Cohesion: 0.10
Nodes (30): AppInner(), AppMain(), getInitialFavoriteProductIds(), TAB_TITLES, CloseAppConfirmSheet(), useToast(), MAX_AUTH_URL, MAX_SELLER_URL (+22 more)

### Community 93 - "commentListLayout.js"
Cohesion: 0.06
Nodes (63): PostUploadContext, PostUploadProvider(), prependPostToFeed(), revalidatePosts(), InfoTooltip(), Toggle(), useMentionNav(), buildSendResultAlert() (+55 more)
...
Cohesion: 0.14
Nodes (13): App(), TournamentPostUploadProvider(), AlertDialogProvider(), Toast(), ToastContext, ToastProvider(), AboutAppModal(), openExternalUrl() (+5 more)

### Community 105 - "FullscreenImageViewer.jsx"
Cohesion: 0.16
Nodes (22): web-demuxer, bindAbort(), compressVideoFfmpeg(), inputExtension(), loadFfmpeg(), compressVideoWebCodecs(), isWebCodecsCompressionAvailable(), pickVideoEncoderConfig() (+14 more)
...
- **Why does `error` connect `usePlayers` to `Post Upload and UI Kit`, `notifications.js`, `gestures.js`, `PostDetailModal.jsx`, `log.js`, `achievements.js`, `ProfilePage.jsx`, `media.js`, `useFetchedOriginal.js`, `isModerator`, `useMaxCloseGuard.js`, `yadiskAlbumLazy.js`, `ArchiveModal.jsx`, `postRichText.js`, `gestures.js`, `commentListLayout.js`, `EditTrainingModal.jsx`, `FullscreenImageViewer.jsx`, `Avatar.jsx`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `dependencies` connect `NPM Dependencies` to `react-dom`, `react-error-boundary`, `notifications.js`, `swr`, `FullscreenImageViewer.jsx`, `tournamentPosts.js`, `PostUploadProvider.jsx`, `PullToRefresh.jsx`, `@ffmpeg/ffmpeg`, `format.js`, `yadiskAlbumLazy.js`, `@fontsource-variable/nunito`, `pocketbase`?**
