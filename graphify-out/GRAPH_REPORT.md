...
## Corpus Check
- 186 files · ~181,835 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 951 nodes · 3012 edges · 58 communities (52 shown, 6 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 109 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a464a588`
...
Cohesion: 0.06
Nodes (50): App(), createGalleryPayload(), GalleryUploadContext, GalleryUploadProvider(), isGalleryKey(), useGalleryUpload(), PostUploadContext, PostUploadProvider() (+42 more)
...
Cohesion: 0.16
Nodes (20): AuditEventRow(), CATEGORY_STYLES, COMMENT_OBJECT_TYPES, COMMENT_SECTION_LABELS, COMMENT_TYPE_LABELS, formatAuditEventDetails(), formatAuditEventPreview(), formatDetailValue() (+12 more)

### Community 7 - "App.jsx"
Cohesion: 0.06
Nodes (70): AppInner(), getInitialFavoriteProductIds(), AvatarCropModal(), getCropCircle(), getImagePlacement(), getCollapsedLabel(), isUserChecked(), UserMultiSelect() (+62 more)
...
Cohesion: 0.06
Nodes (57): AppMain(), TAB_TITLES, ADMIN_NAV_ITEM, NAV_ITEMS, usePostUpload(), TournamentPostUploadContext, TournamentPostUploadProvider(), useTournamentPostUpload() (+49 more)
...
Cohesion: 0.11
Nodes (31): AchievementRow(), AchievementsBlock(), clampProgress(), getCurrentLevelTitle(), getProgressBarColorClass(), getTooltipKey(), getTooltipText(), clampPercent() (+23 more)
...
Cohesion: 0.17
Nodes (19): Toast(), ToastContext, ToastProvider(), useToast(), BlockedPage(), formatFreezeLogEntry(), formatMembershipDate(), getMembershipTypeLabel() (+11 more)

### Community 16 - "StatsGrowthModal.jsx"
Cohesion: 0.24
Nodes (10): formatBirthDate(), formatDayTitle(), StatsGrowthModal(), StatsLineChart(), fetchStatsBooking(), fetchStatsGrowth(), fetchStatsGrowthDay(), fetchStatsReach() (+2 more)
...
Cohesion: 0.06
Nodes (55): react, Avatar(), TournamentCommentsSection(), getParticipantDisplayName(), getParticipantPlayer(), PODIUM_ORDER, TournamentPodium(), readTournamentComments() (+47 more)

### Community 57 - "log.js"
Cohesion: 0.07
Nodes (67): AlertDialogContext, INITIAL_STATE, useAlertDialog(), useFavorites(), CreateTournamentPostModal(), EditTournamentPostModal(), CreatePostModal(), EditPostModal() (+59 more)

### Community 61 - "Modal.jsx"
Cohesion: 0.18
Nodes (11): FOCUSABLE_SELECTORS, Modal(), Toggle(), NotificationSettingsModal(), SETTINGS_ROWS, METRICS, StatisticsHubModal(), INITIAL (+3 more)
...
- **Why does `error` connect `App Shell Navigation` to `Post Upload and UI Kit`, `Gallery Upload Flow`, `App.jsx`, `Audit Logs Modal`, `Achievements UI Block`, `FullscreenImageViewer.jsx`, `PostDetailModal.jsx`, `log.js`, `Modal.jsx`?**
