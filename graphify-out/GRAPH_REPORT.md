...
## Corpus Check
- 265 files · ~245,717 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1387 nodes · 4296 edges · 91 communities (82 shown, 9 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 150 edges (avg confidence: 0.59)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `95598504`
...
Cohesion: 0.14
Nodes (27): usePostUpload(), ScrollToTopButton(), FeedListSkeleton(), RatingListSkeleton(), ShopGridSkeleton(), TrainingListSkeleton(), useRegisterAddAction(), useMentionNav() (+19 more)
...
Cohesion: 0.27
Nodes (7): ForceUpdateOverlay(), MentionSuggestPopup(), prefersReducedMotion(), ScheduledPostActionsMenu(), CategoryDropdown(), useOverlayClose(), registerOverlay()
...
Cohesion: 0.06
Nodes (62): Avatar(), FrameColorPicker(), hexToHsv(), hsvToHex(), applyMentionMissingStatuses(), postInflight, postMissingCache, resolvePostMissing() (+54 more)
...
Cohesion: 0.07
Nodes (51): carouselSlideKey(), FullscreenSlideImage(), getOriginRect(), getWindowWidth(), isImagePaintReady(), itemSlideId(), useYadiskLoadProgress(), MediaPreviewAlbumItem() (+43 more)

### Community 59 - "yadiskAlbumLazy.js"
Cohesion: 0.06
Nodes (74): AlertDialogContext, INITIAL_STATE, useAlertDialog(), FOCUSABLE_SELECTORS, Modal(), useToast(), useFavorites(), SystemTemplatesModal() (+66 more)
...
Cohesion: 0.05
Nodes (78): IconButton, MembershipIcon(), getCollapsedLabel(), isUserChecked(), UserMultiSelect(), CARD_STEPS, getStepSelectors(), getTooltipStyle() (+70 more)

### Community 65 - "ProfilePage.jsx"
Cohesion: 0.08
Nodes (39): PB_URL, useFetchedOriginal(), formatCountdownPart(), formatTrainingCountdownBadge(), isUserBooked(), CLICK_ACTION_LABELS, NotificationCard(), parseCommentReplyParentText() (+31 more)
...
Cohesion: 0.06
Nodes (53): ModalFloatingCloseButton(), MentionNavContext, MentionNavProvider(), TournamentCommentsSection(), getParticipantDisplayName(), getParticipantPlayer(), PODIUM_ORDER, TournamentPodium() (+45 more)
...
Cohesion: 0.16
Nodes (12): createGalleryPayload(), GalleryUploadContext, GalleryUploadProvider(), isGalleryKey(), PostUploadContext, PostUploadProvider(), AlertDialogProvider(), Toast() (+4 more)

### Community 83 - "error"
Cohesion: 0.23
Nodes (10): usePostLikes(), usePosts(), error, deleteScheduledPost(), listPostLikes(), listPosts(), listScheduledPosts(), publishScheduledPostNow() (+2 more)
...
Cohesion: 0.17
Nodes (15): AppInner(), AppMain(), getInitialFavoriteProductIds(), TAB_TITLES, CloseAppConfirmSheet(), MAX_AUTH_URL, MAX_SELLER_URL, BlockedPage() (+7 more)
...
- **Why does `error` connect `error` to `ProfilePage.jsx`, `Post Upload and UI Kit`, `App.jsx`, `media.js`, `GalleryCommentModal.jsx`, `notifications.js`, `tournamentPosts.js`, `isModerator`, `GalleryPage.jsx`, `main.jsx`, `RatingPage.jsx`, `FavoritesContext.jsx`, `log.js`, `achievements.js`, `yadiskAlbumLazy.js`, `catalog.js`?**
