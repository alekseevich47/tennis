...
## Corpus Check
- 190 files · ~183,970 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 968 nodes · 3056 edges · 58 communities (52 shown, 6 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 110 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `390d3970`
...
Cohesion: 0.08
Nodes (69): AppMain(), CalendarStrip(), buildTrainingPatch(), EditTrainingModal(), getFormFromTraining(), getPatchFromForm(), getPatchFromTraining(), INITIAL_FORM (+61 more)
...
Cohesion: 0.14
Nodes (31): Toggle(), buildSendResultAlert(), formatAdminSaveError(), BroadcastModal(), defaultDatetimeLocal(), getAudienceLabel(), defaultDatetimeLocal(), getAudienceLabel() (+23 more)

### Community 3 - "notifications.js"
Cohesion: 0.23
Nodes (15): formatCountdownPart(), formatTrainingCountdownBadge(), isUserBooked(), CLICK_ACTION_LABELS, NotificationCard(), NotificationsDropdown(), formatRelativeTime(), pluralize() (+7 more)

### Community 4 - "Gallery Upload Flow"
Cohesion: 0.08
Nodes (40): createGalleryPayload(), GalleryUploadContext, GalleryUploadProvider(), isGalleryKey(), useGalleryUpload(), isProductsKey(), ProductUploadContext, ProductUploadProvider() (+32 more)

### Community 5 - "Admin UI Controls"
Cohesion: 0.11
Nodes (30): EmptyState(), InfoTooltip(), Spinner(), MODES, StatsAchievementsModal(), hasAnyActivity(), SLICES, StatsBookingModal() (+22 more)
...
### Community 7 - "App.jsx"
Cohesion: 0.09
Nodes (41): clampPercent(), computeGridLayout(), FloatingAchievements(), hashUnit(), formatDate(), getTrainingStatusForUser(), getTrainingTitle(), getUserPastTrainings() (+33 more)
...
Cohesion: 0.12
Nodes (27): PostUploadContext, PostUploadProvider(), usePostUpload(), FeedPage(), applyPinFocusHighlight(), computePinnedBannerIndex(), pinHighlightTimers, sortPinnedByCreated() (+19 more)

### Community 10 - "LogsModal.jsx"
Cohesion: 0.06
Nodes (61): App(), AppInner(), getInitialFavoriteProductIds(), TAB_TITLES, ADMIN_NAV_ITEM, NAV_ITEMS, TournamentPostUploadContext, TournamentPostUploadProvider() (+53 more)
...
Cohesion: 0.12
Nodes (30): AppHeader(), computeAnnualEndDate(), getCurrentSessions(), getModeCopy(), MembershipEditModal(), normalizeDateInput(), MembershipPeriodRangeField(), MembershipStartDateField() (+22 more)
...
Cohesion: 0.60
Nodes (5): handleReplyCreate(), notifyCommentReply(), relationId(), stripHtmlToPlain(), truncatePlain()
...
Cohesion: 0.05
Nodes (80): react, Avatar(), TournamentCommentsSection(), getParticipantDisplayName(), getParticipantPlayer(), PODIUM_ORDER, TournamentPodium(), readTournamentComments() (+72 more)

### Community 57 - "log.js"
Cohesion: 0.09
Nodes (49): AlertDialogContext, INITIAL_STATE, useAlertDialog(), IconButton, FOCUSABLE_SELECTORS, Modal(), useFavorites(), CreateTournamentPostModal() (+41 more)
...
- **Why does `error` connect `Post Upload and UI Kit` to `App Shell Navigation`, `notifications.js`, `Gallery Upload Flow`, `App.jsx`, `Audit Logs Modal`, `LogsModal.jsx`, `Achievements UI Block`, `FullscreenImageViewer.jsx`, `PostDetailModal.jsx`, `log.js`?**
