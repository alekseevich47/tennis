...
## Corpus Check
- 186 files · ~181,944 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 954 nodes · 3015 edges · 63 communities (57 shown, 6 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 109 edges (avg confidence: 0.61)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `08fe0589`
...
Cohesion: 0.08
Nodes (72): AppMain(), CalendarStrip(), buildTrainingPatch(), EditTrainingModal(), getFormFromTraining(), getPatchFromForm(), getPatchFromTraining(), INITIAL_FORM (+64 more)
...
Cohesion: 0.12
Nodes (28): InfoTooltip(), Toggle(), buildSendResultAlert(), formatAdminSaveError(), BroadcastModal(), defaultDatetimeLocal(), getAudienceLabel(), defaultDatetimeLocal() (+20 more)
...
Cohesion: 0.12
Nodes (29): EmptyState(), Spinner(), MODES, StatsAchievementsModal(), hasAnyActivity(), SLICES, StatsBookingModal(), formatBirthDate() (+21 more)
...
Cohesion: 0.09
Nodes (45): usePostUpload(), TournamentPostUploadContext, TournamentPostUploadProvider(), useTournamentPostUpload(), CompetitionsPage(), TABS, FeedPage(), applyPinFocusHighlight() (+37 more)

### Community 10 - "LogsModal.jsx"
Cohesion: 0.21
Nodes (9): AppInner(), getInitialFavoriteProductIds(), TAB_TITLES, ADMIN_NAV_ITEM, NAV_ITEMS, AdminPanelPage(), BlockedPage(), useSessionResetKey() (+1 more)
...
Cohesion: 0.09
Nodes (40): AppHeader(), AlertDialogContext, INITIAL_STATE, useAlertDialog(), IconButton, FOCUSABLE_SELECTORS, Modal(), AddImageModal() (+32 more)

### Community 15 - "FullscreenImageViewer.jsx"
Cohesion: 0.13
Nodes (22): App(), PostUploadContext, PostUploadProvider(), AlertDialogProvider(), Toast(), ToastContext, ToastProvider(), useToast() (+14 more)
...
Cohesion: 0.06
Nodes (74): react, Avatar(), TournamentCommentsSection(), getParticipantDisplayName(), getParticipantPlayer(), PODIUM_ORDER, TournamentPodium(), readTournamentComments() (+66 more)

### Community 57 - "log.js"
Cohesion: 0.13
Nodes (37): useFavorites(), CreateTournamentPostModal(), EditTournamentPostModal(), CreatePostModal(), EditPostModal(), FullscreenImageViewer(), getOriginRect(), getWindowWidth() (+29 more)

### Community 58 - "auth.js"
Cohesion: 0.38
Nodes (11): getInitialUser(), useMaxAuth(), buildBannedUser(), clearBanInfo(), finalizeBannedUser(), initMaxAuth(), isUserBanned(), loadBanInfo() (+3 more)

### Community 59 - "MembershipOverviewModal.jsx"
Cohesion: 0.28
Nodes (9): getCollapsedLabel(), isUserChecked(), UserMultiSelect(), formatDateRangeLabel(), MembershipOverviewModal(), trainingCountsAsUsedSession(), usePlayers(), useTrainings() (+1 more)
...
- **Why does `error` connect `App Shell Navigation` to `Post Upload and UI Kit`, `notifications.js`, `Gallery Upload Flow`, `App.jsx`, `Audit Logs Modal`, `LogsModal.jsx`, `Achievements UI Block`, `datePickerUtils.js`, `FullscreenImageViewer.jsx`, `StatsGrowthModal.jsx`, `PostDetailModal.jsx`, `log.js`, `auth.js`, `MembershipOverviewModal.jsx`, `pb.js`, `Modal.jsx`, `ProfilePage.jsx`?**
