...
## Corpus Check
- 299 files · ~264,709 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1540 nodes · 4761 edges · 106 communities (95 shown, 11 thin omitted)
...
Cohesion: 0.10
Nodes (45): PinnedBanner(), usePinnedThumbUrl(), useFetchedOriginal(), publishAlbums(), useResolvedExternalMedia(), useYadiskEmbed(), getYadiskAlbumCache(), setYadiskAlbumCache() (+37 more)
...
Cohesion: 0.05
Nodes (74): commentHasAttachments(), CommentsPreview(), handleContentCopy(), plainTextFromRange(), FrameColorPicker(), hexToHsv(), hsvToHex(), applyMentionMissingStatuses() (+66 more)
...
Cohesion: 0.09
Nodes (40): AppHeader(), MembershipIcon(), useFavorites(), applyRegularPeriodAuto(), computeTwoMonthEndDate(), computeYearEndDate(), getCurrentSessions(), getModeCopy() (+32 more)
...
### Community 57 - "log.js"
Cohesion: 0.12
Nodes (32): TrainingsPage(), canCancelBooking(), addPendingDeleteTrainingId(), areTrainingValuesEqual(), assertMembershipSessionAvailable(), assertNotBotBlocked(), bookTraining(), bookUsersToTraining() (+24 more)
...
Cohesion: 0.06
Nodes (56): InfoTooltip(), FOCUSABLE_SELECTORS, Modal(), Spinner(), Toggle(), AdminPanelPage(), NotificationSettingsModal(), SETTINGS_ROWS (+48 more)

### Community 65 - "ProfilePage.jsx"
Cohesion: 0.15
Nodes (25): AppInner(), AppMain(), getInitialFavoriteProductIds(), TAB_TITLES, CloseAppConfirmSheet(), AddActionProvider(), MentionNavProvider(), getInitialUser() (+17 more)

### Community 67 - "media.js"
Cohesion: 0.20
Nodes (16): useProductUpload(), PriceRangeSlider(), SearchBar(), ShopFilterButton(), countActiveShopFilters(), DEFAULT_SHOP_FILTERS, getPriceBounds(), productMatchesFilters() (+8 more)

### Community 68 - "GalleryCommentModal.jsx"
Cohesion: 0.21
Nodes (12): FeedListSkeleton(), RatingListSkeleton(), ShopGridSkeleton(), TrainingListSkeleton(), AddActionContext, DEFAULT_API, useRegisterAddAction(), RatingPage() (+4 more)
...
Cohesion: 0.18
Nodes (13): App(), createGalleryPayload(), GalleryUploadContext, GalleryUploadProvider(), getVideoAspectRatio(), isGalleryKey(), prepareGalleryUploadItem(), AlertDialogProvider() (+5 more)

### Community 78 - "tournamentPosts.js"
Cohesion: 0.20
Nodes (11): CommentListSkeleton(), CommentReplyComposeBar(), CommentReplyQuote(), CommentSendButton(), GalleryCommentModal(), useCommentLikes(), createGalleryComment(), deleteGalleryComment() (+3 more)

### Community 79 - "isModerator"
Cohesion: 0.13
Nodes (30): usePostUpload(), useTournamentPostUpload(), ScrollToTopButton(), MentionNavContext, useMentionNav(), CompetitionsPage(), TABS, groupPostsByDay() (+22 more)

### Community 80 - "useMaxCloseGuard.js"
Cohesion: 0.06
Nodes (87): react, AlertDialogContext, INITIAL_STATE, useAlertDialog(), CreateTournamentPostModal(), EditTournamentPostModal(), AttachButtons(), CommentComposeForm() (+79 more)

### Community 81 - "PostUploadProvider.jsx"
Cohesion: 0.60
Nodes (4): useGalleryComments(), useProgressiveComments(), listGalleryComments(), listRecentGalleryComments()

### Community 82 - "main.jsx"
Cohesion: 0.22
Nodes (12): carouselSlideKey(), FullscreenImageViewer(), FullscreenSlideImage(), getOriginRect(), getWindowWidth(), isImagePaintReady(), isTouchNavDevice(), itemSlideId() (+4 more)

### Community 83 - "yadiskAlbumLazy.js"
Cohesion: 0.08
Nodes (28): ForceUpdateOverlay(), CommentContextMenu(), groupCommentsByDay(), groupItemsByDay(), mapCommentsWithDaySeparators(), mapItemsWithDaySeparators(), mapPostsWithDaySeparators(), PAD (+20 more)
...
Cohesion: 0.28
Nodes (11): ModalFloatingCloseButton(), findScrollParent(), keepCommentEditInView(), restoreAndKeepCommentEditInView(), PostDetailModal(), useComments(), buildCommentMediaReorderFormData(), hardDeleteComment() (+3 more)
...
Cohesion: 0.30
Nodes (9): PostCard(), PostCardLike(), readComments(), usePostLikes(), usePostViewTracker(), formatCommentTime(), listPostLikes(), togglePostLike() (+1 more)

### Community 89 - "usePlayers"
Cohesion: 0.36
Nodes (9): TrainingCard(), TrainingDetailModal(), useKeepForModalClose(), formatCardDate(), formatTimeRange(), hasTimeRangeEnded(), markAttendance(), removeUsersFromTraining() (+1 more)
...
Cohesion: 0.09
Nodes (36): Toast(), ToastContext, ToastProvider(), useToast(), MAX_SELLER_URL, CommentListItem(), CommentReplyButton(), CommentSwipeReply() (+28 more)

### Community 92 - "gestures.js"
Cohesion: 0.12
Nodes (17): AvatarCropModal(), getCropCircle(), getImagePlacement(), FeedVideoPreview(), MediaPreviewAlbumItem(), MediaPreviewGrid(), useSwipeGallery(), carouselSlideKey() (+9 more)
...
Cohesion: 0.29
Nodes (6): EmptyState(), IconButton, PullToRefresh(), useSectionScroll(), hasOpenOverlay(), setSectionScrollElement()

### Community 96 - "videoPreviewUrl"
Cohesion: 0.28
Nodes (11): TournamentCommentsSection(), useTournamentComments(), mapUploadProgress(), buildTournamentCommentMediaReorderFormData(), createTournamentComment(), createTournamentCommentWithProgress(), flushPendingTournamentCommentDeletes(), hardDeleteTournamentComment() (+3 more)

### Community 98 - "NotificationCard.jsx"
Cohesion: 0.28
Nodes (5): isUserBookingDisabled(), UserPickerModal(), CreateTrainingModal(), INITIAL_FORM, createTraining()
...
Cohesion: 0.21
Nodes (14): TournamentPostUploadContext, TournamentPostUploadProvider(), useTournamentPosts(), applyTournamentPostSideEffects(), buildTournamentPostPayload(), deleteScheduledTournamentPost(), invalidateTournamentCaches(), listTournamentPosts() (+6 more)
...
Cohesion: 0.33
Nodes (7): formatDateRangeLabel(), MembershipOverviewModal(), trainingCountsAsUsedSession(), usePlayers(), useTrainings(), listPlayers(), listTrainings()

### Community 114 - "Avatar.jsx"
Cohesion: 0.18
Nodes (14): MAX_AUTH_URL, PB_URL, useProducts(), addGalleryImage(), buildManualPlayerPayload(), createGalleryFormData(), createPlayer(), createProduct() (+6 more)
...
- **Why does `error` connect `Admin UI Controls` to `Post Upload and UI Kit`, `notifications.js`, `datePickerUtils.js`, `PostDetailModal.jsx`, `log.js`, `achievements.js`, `catalog.js`, `ProfilePage.jsx`, `media.js`, `GalleryCommentModal.jsx`, `useFetchedOriginal.js`, `NotificationSettingsModal.jsx`, `tournamentPosts.js`, `isModerator`, `useMaxCloseGuard.js`, `PostUploadProvider.jsx`, `yadiskAlbumLazy.js`, `ArchiveModal.jsx`, `PostMedia.jsx`, `format.js`, `usePlayers`, `postRichText.js`, `gestures.js`, `commentListLayout.js`, `App.jsx`, `videoPreviewUrl`, `NotificationCard.jsx`, `EditTrainingModal.jsx`, `tournamentPosts.js`, `ProductForm.jsx`, `compressImage`, `Avatar.jsx`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `react` connect `useMaxCloseGuard.js` to `NPM Dependencies`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `dependencies` connect `NPM Dependencies` to `useMaxCloseGuard.js`?**
