...
## Corpus Check
- 214 files · ~203,282 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1074 nodes · 3301 edges · 70 communities (63 shown, 7 thin omitted)
...
Cohesion: 0.06
Nodes (60): react, ADMIN_NAV_ITEM, GALLERY_NAV_ITEM, NAV_ITEMS, Avatar(), IconButton, TournamentCommentsSection(), getParticipantDisplayName() (+52 more)

### Community 59 - "App.jsx"
Cohesion: 0.05
Nodes (68): AppInner(), getInitialFavoriteProductIds(), TAB_TITLES, CloseAppConfirmSheet(), CARD_STEPS, getStepSelectors(), getTooltipStyle(), NAV_STEPS (+60 more)
...
Cohesion: 0.08
Nodes (42): createGalleryPayload(), GalleryUploadContext, GalleryUploadProvider(), isGalleryKey(), useGalleryUpload(), isProductsKey(), ProductUploadContext, ProductUploadProvider() (+34 more)
...
- **Why does `error` connect `Post Upload and UI Kit` to `App Shell Navigation`, `OnboardingTutorial.jsx`, `RatingPage.jsx`, `App.jsx`, `MembershipModal.jsx`, `datePickerUtils.js`, `log.js`, `catalog.js`, `App.jsx`?**
