...
## Corpus Check
- 316 files · ~275,046 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1823 nodes · 5200 edges · 138 communities (116 shown, 22 thin omitted)
...
Cohesion: 0.19
Nodes (24): publishAlbums(), useResolvedExternalMedia(), useYadiskEmbed(), setYadiskAlbumCache(), createAlbumWindowController(), createPriorityQueue(), fetchAlbumMemberBytes(), focusListeners (+16 more)

### Community 3 - "notifications.js"
Cohesion: 0.09
Nodes (31): FullscreenImageViewer(), FullscreenSlideImage(), getOriginRect(), getWindowWidth(), isImagePaintReady(), isTouchNavDevice(), useYadiskLoadProgress(), FullscreenSlideVideo() (+23 more)
...
Cohesion: 0.17
Nodes (17): isProductsKey(), ProductUploadContext, ProductUploadProvider(), ProductParamTemplatesModal(), useProductParamTemplates(), useProducts(), addGalleryImage(), createGalleryFormData() (+9 more)
...
Cohesion: 0.19
Nodes (13): EmptyState(), MembershipIcon(), formatDate(), getTrainingStatusForUser(), getTrainingTitle(), getUserPastTrainings(), normalizeDateInput(), ProfilePage() (+5 more)
...
Cohesion: 0.11
Nodes (22): AvatarCropModal(), getCropCircle(), getImagePlacement(), CommentContextMenu(), CARD_STEPS, getStepSelectors(), getTooltipStyle(), NAV_STEPS (+14 more)

### Community 57 - "log.js"
Cohesion: 0.06
Nodes (76): base(), PAD, ScheduleDateTimeSheet(), CalendarStrip(), buildTrainingPatch(), EditTrainingModal(), getFormFromTraining(), getPatchFromForm() (+68 more)
...
Cohesion: 0.31
Nodes (6): ForceUpdateOverlay(), ScheduledPostActionsMenu(), CategoryDropdown(), useOverlayClose(), useProductCategories(), listProductCategories()

### Community 67 - "media.js"
Cohesion: 0.18
Nodes (17): useProductUpload(), PriceRangeSlider(), normalizeProductCategoryIds(), SearchBar(), ShopFilterButton(), countActiveShopFilters(), DEFAULT_SHOP_FILTERS, getPriceBounds() (+9 more)

### Community 68 - "GalleryCommentModal.jsx"
Cohesion: 0.40
Nodes (8): buildSendResultAlert(), formatAdminSaveError(), defaultDatetimeLocal(), getAudienceLabel(), NotificationSendModal(), cancelScheduledNotification(), listScheduledNotifications(), toDatetimeLocalValue()

### Community 70 - "useFetchedOriginal.js"
Cohesion: 0.31
Nodes (7): ProductCard, carouselSlideKey(), ProductGallery(), slideId(), normalizeOldPrice(), ProductPrice(), useGalleryNavigation()
...
Cohesion: 0.20
Nodes (15): TournamentPostUploadContext, TournamentPostUploadProvider(), useTournamentPosts(), applyTournamentPostSideEffects(), buildTournamentPostPayload(), deleteScheduledTournamentPost(), hardDeleteTournamentPost(), invalidateTournamentCaches() (+7 more)

### Community 80 - "useMaxCloseGuard.js"
Cohesion: 0.15
Nodes (17): PullToRefresh(), FeedListSkeleton(), RatingListSkeleton(), ShopGridSkeleton(), TrainingListSkeleton(), AddActionContext, AddActionProvider(), DEFAULT_API (+9 more)

### Community 81 - "PostUploadProvider.jsx"
Cohesion: 0.13
Nodes (33): prefetchLazyTabPages(), usePostUpload(), useTournamentPostUpload(), ScrollToTopButton(), MentionNavContext, useMentionNav(), CompetitionsPage(), TABS (+25 more)
...
Cohesion: 0.06
Nodes (58): MAX_AUTH_URL, MAX_SELLER_URL, PB_URL, applyMentionMissingStatuses(), isPostMissing(), postInflight, postMissingCache, resolvePostMissing() (+50 more)
...
Cohesion: 0.18
Nodes (14): AppMain(), LazyAdminPanelPage, LazyCompetitionsPage, LazyGalleryPage, LazyOnboardingTutorial, LazyProfilePage, LazyShopPage, LazyTrainingsPage (+6 more)
...
Cohesion: 0.22
Nodes (7): LazyStatsAchievementsModal, LazyStatsBookingModal, LazyStatsGrowthModal, LazyStatsReachModal, LazyStatsTrainingsCountModal, METRICS, StatisticsHubModal()
...
Cohesion: 0.21
Nodes (16): ProductDetail(), areStringArraysEqual(), areStringSetsEqual(), INITIAL, parseOptionalOldPrice(), parsePrice(), ProductForm(), areProductColorsEqual() (+8 more)

### Community 114 - "GalleryPage.jsx"
Cohesion: 0.19
Nodes (11): App(), PostUploadContext, PostUploadProvider(), prependPostToFeed(), revalidatePosts(), AlertDialogProvider(), Toast(), ToastContext (+3 more)
...
Cohesion: 0.53
Nodes (9): error, buildBroadcastRecordPayload(), createScheduledBroadcast(), createScheduledNotification(), dispatchNow(), fromDatetimeLocalValue(), triggerBackup(), updateScheduledBroadcast() (+1 more)
...
Cohesion: 0.05
Nodes (70): TournamentCommentsSection(), CommentListItem(), groupCommentsByDay(), groupItemsByDay(), isKnownEmptyExpandedComments(), mapCommentsWithDaySeparators(), mapItemsWithDaySeparators(), mapPostsWithDaySeparators() (+62 more)

### Community 125 - "AboutAppModal.jsx"
Cohesion: 0.16
Nodes (9): commentHasAttachments(), CommentsPreview(), handleContentCopy(), plainTextFromRange(), PostCard(), readComments(), PostContentHtml(), ScheduledPostRow() (+1 more)
...
Cohesion: 0.16
Nodes (32): react, useAlertDialog(), useToast(), AdminPanelPage(), CreateTournamentPostModal(), EditTournamentPostModal(), AttachButtons(), CommentComposeForm() (+24 more)
...
Cohesion: 0.17
Nodes (14): AlertDialogContext, INITIAL_STATE, BroadcastModal(), defaultDatetimeLocal(), getAudienceLabel(), AddImageModal(), compressImage(), hasTransparency() (+6 more)
...
- **Why does `ScheduleDateTimeSheet()` connect `log.js` to `UTF8ToString`, `ProfilePage.jsx`, `AboutAppModal.jsx`?**
  _High betweenness centrality (0.168) - this node is a cross-community bridge._
- **Why does `base()` connect `log.js` to `yadiskAlbumLazy.js`?**
  _High betweenness centrality (0.167) - this node is a cross-community bridge._
- **Why does `error` connect `EditTrainingModal.jsx` to `UTF8ToString`, `Skeleton.jsx`, `Post Upload and UI Kit`, `FavoritesContext.jsx`, `auditEventFormat.js`, `datePickerUtils.js`, `compressImage`, `PostDetailModal.jsx`, `log.js`, `achievements.js`, `ProfilePage.jsx`, `media.js`, `GalleryCommentModal.jsx`, `isModerator`, `useMaxCloseGuard.js`, `PostUploadProvider.jsx`, `ArchiveModal.jsx`, `PullToRefresh.jsx`, `buyMessage.js`, `usePlayers`, `postRichText.js`, `gestures.js`, `useAlertDialog`, `LogsModal.jsx`, `GalleryPage.jsx`, `usePinnedBannerIndex.js`, `AboutAppModal.jsx`?**
